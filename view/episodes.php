    ...
    <div class="grow flex flex-col w-full md:w-auto justify-between leading-normal self-start">
      <div class="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
        <ul class="flex flex-wrap -mb-px">
          ...
          <li class="mr-2">
            <a href="?v=episodes" class="inline-block p-2 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-gray-100 dark:border-blue-500">Episodes</a>
          </li>
        </ul>
      </div>
      <nav class="flex my-3">
      ...
      <div>
        <h4 class="text-xl mb-3 font-bold capitalize dark:text-white my-2">Episodes(6/23)</h4>
                ...
                <tr class="border-b border-[#262626] odd:bg-[#181818]">
                  ...
                  <td class="px-6 py-4">
                    <div class="inline-flex flex-col space-y-1">
                      <a href="" class="max-w-fit font-semibold decoration-sky-500/60 text-gray-200 hover:text-white underline-offset-4 hover:underline hover:decoration-blue-600 hover:decoration-2"><?= $eps->getTitle(); ?></a>
                      <span class="text-sm"><?= $eps->getTitleRomanji(); ?> (<?= $eps->getTitleJapanese(); ?>)</span>
                    </div>
                  </td>
                  <td class="px-6 py-4">
                    <?= $eps->getAired()->format('M d, Y'); ?>
                  </td>
                  <td class="px-6 py-4">
                  </td>
